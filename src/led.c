...
#define LED9_DDR    DDRC
#define LED9_PORT   PORTC
#define LED9_PIN    PC0

#define LED10_DDR    DDRC
#define LED10_PORT   PORTC
#define LED10_PIN    PC1
...
void led_on(uint16_t ledNr)
{
    ...
    case 9: { LED9_PORT |= (1 << LED9_PIN); }break;
    case 10: { LED10_PORT |= (1 << LED10_PIN); }break;
    default:
        break;
    }
}
